...
import { incomeBands } from '../app/src/lib.js';
...
console.log('\nIncome ranges a household of 4 picks from (one dropdown):');
for (const b of incomeBands(ruleset, incomeInput, 4)) console.log(`  ${b.label}`);
